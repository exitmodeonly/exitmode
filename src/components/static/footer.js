        ...
        <div className="w-full z-20 bg-transparent">
            <div className="mx-4 sm:mx-0 flex flex-warp items-center justify-between py-4 sm:flex-row sm:space-y-0">
                ...
                <div className="text-sm text-gray-500">
                    Made with <span className="text-red-500">♥</span> by <a href="https://github.com/Lufixy" target="_blank" rel="noreferrer" className="text-white-500 hover:text-gray-600 underline">HOPE</a>
                </div>
            </div>
        </div>
    )
