...
export function SiteFeatures() {
    ...
    // "features": {
    //     "title": "Особенности",
    //     "vanguard": "Защита vanguard",
    //     "vanguard_text": "vanguard - это сокращение от Valve Anti-Cheat. Эта система представляет собой автоматизированную систему античит, разработанную и эксплуатируемую компанией Valve. Она призвана предотвратить мошенничество в играх и обеспечить честное игровое окружение.",
    ...
    <Tilt className="Tilt" options={{ max : 25 }} >
        <div classsName="w-full h-full bg-accent/25 overflow-hidden shadow rounded-lg ring-black/50 ring-2 dark:ring-0">
            <div className="px-4 py-5 sm:p-6">
                ...
                <div className="mt-5 flex justify-center items-center">
                <span className="text-3xl font-semibold text-center dark:text-white text-black">{t('features.vanguard')}</span>
                </div>
                <div className="mt-5 flex justify-center items-center">
                <span className="text-sm font-semibold text-center dark:text-gray-500 text-black">{t('features.vanguard_text')}</span>
                </div>
            </div>
        </div>
    </Tilt>
